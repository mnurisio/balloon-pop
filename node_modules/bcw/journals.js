#!/usr/bin/env node
const { printAlert, clearScreen, colors, printInfo, printSuccess, printBanner, printFSLogo, printSECLogo } = require("./utils/console-utils.js");
const { setupGit, initializeProject, getOrSetGitUser } = require("./utils");
